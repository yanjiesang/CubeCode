...
namespace Utils {
        ...
        JsonParser::ResponseCode JsonParser::InitializeFromJsonFile(JsonDocument &json_document,
                                                        const JsonParser::String &input_file_path) {
        ...
        JsonParser::ResponseCode JsonParser::InitializeFromJsonString(JsonDocument &json_document,
                                                            const JsonParser::String &config_json_string) {
        ...
        JsonParser::ResponseCode JsonParser::GetBoolValue(const JsonDocument &json_document, const char *key, bool &value) {
        ...
        JsonParser::ResponseCode JsonParser::GetIntValue(const JsonDocument &json_document, const char *key, int &value) {
            if (!json_document.HasMember(key)) {
                return ResponseCode::JSON_PARSE_KEY_NOT_FOUND_ERROR;
            }
        ...
        JsonParser::ResponseCode JsonParser::GetUint16Value(const JsonDocument &json_document, const char *key, uint16_t &value) {
            if (!json_document.HasMember(key)) {
                return ResponseCode::JSON_PARSE_KEY_NOT_FOUND_ERROR;
            }
        ...
        JsonParser::ResponseCode JsonParser::GetUint32Value(const JsonDocument &json_document, const char *key, uint32_t &value) {
            if (!json_document.HasMember(key)) {
                return ResponseCode::JSON_PARSE_KEY_NOT_FOUND_ERROR;
            }
        ...
        JsonParser::ResponseCode JsonParser::GetSizeTValue(const JsonDocument &json_document, const char *key, size_t &value) {
            if (!json_document.HasMember(key)) {
                return ResponseCode::JSON_PARSE_KEY_NOT_FOUND_ERROR;
            }
        ...
        JsonParser::ResponseCode JsonParser::GetCStringValue(const JsonDocument &json_document,
                                                    const char *key,
                                                    char *value,
        ...
        JsonParser::ResponseCode JsonParser::GetStringValue(const JsonDocument &json_document,
                                                const char *key,
        ...
        JsonParser::ResponseCode JsonParser::MergeValues(JsonValue &target,
                                                JsonValue &source,
            ...
            JsonParser::JsonValue::MemberIterator target_itr;
            JsonParser::JsonValue::MemberIterator source_itr = source.MemberBegin();
        ...
        // be to sort the json and bring it down to O(nlog(n)). But changing the json structure
        // might not be desired. Provide a second implementation that does this with an option
        JsonParser::ResponseCode JsonParser::DiffValues(JsonValue &target_doc,
                                            JsonValue &old_doc,
                                            JsonValue &new_doc,
                                            JsonValue::AllocatorType &allocator) {
            ...
            JsonParser::JsonValue::MemberIterator old_doc_itr;
            JsonParser::JsonValue::MemberIterator new_doc_itr = new_doc.MemberBegin();
        ...
        JsonParser::String JsonParser::ToString(JsonDocument &json_document) {
            rapidjson::StringBuffer buffer;
            buffer.Clear();
            rapidjson::PrettyWriter <rapidjson::StringBuffer> writer(buffer);
            json_document.Accept(writer);

            return JsonParser::String(buffer.GetString());
        }

        JsonParser::String JsonParser::ToString(JsonValue &json_value) {
            rapidjson::StringBuffer buffer;
            buffer.Clear();
            rapidjson::PrettyWriter <rapidjson::StringBuffer> writer(buffer);
        ...
        JsonParser::ResponseCode JsonParser::WriteToFile(JsonDocument &json_document, const JsonParser::String &output_file_path) {
            ...
            JsonParser::String json_document_string = ToString(json_document);
